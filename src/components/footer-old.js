...
const Footer = () => (
  <section className="ds section ds footer x-undefined y-background-far grid">
    <div className="wrapper grid span-grid spaced">
      <div className="title span-8 md-start-2 md-span-12">
        ...
        <div className="ds theme-selector hide-on-mobile"><span className="c-x x-paragraph">Light Theme</span><button
          className="ds toggle-switch" type="button"><input type="checkbox" id="theme-toggle"/><label
            for="theme-toggle"></label></button></div>
      </div>
